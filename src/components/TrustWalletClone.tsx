...
import { Settings, MoreHorizontal, Search, ScanLine, FileClock, Settings2, RefreshCw, ChevronDown, Compass, LineChart } from 'lucide-react';
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 px-4 py-2">
        <div className="flex justify-around items-center">
          ...
          <button className="flex flex-col items-center space-y-1 py-2">
            ...
            <span className="text-xs text-gray-500">Descubra</span>
          </button>
        </div>
      </div>
